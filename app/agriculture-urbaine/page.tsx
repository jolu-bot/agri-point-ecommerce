          ...
          {loading ? (
            ...
            <div className="text-center py-16 px-6 rounded-2xl bg-gray-50 dark:bg-gray-800/40 border border-dashed border-gray-200 dark:border-gray-700">
              ...
              <p className="font-semibold text-gray-700 dark:text-gray-300 mb-1">
                {locale === 'en' ? 'Kits coming soon' : 'Kits disponibles prochainement'}
              </p>
              <p className="text-sm text-gray-400 dark:text-gray-500">
                {locale === 'en'
                  ? 'Our urban kits are being prepared. See our full catalogue below.'
                  : 'Nos kits urbains sont en préparation. Consultez notre catalogue complet ci-dessous.'}
              </p>
            </div>
          )}
