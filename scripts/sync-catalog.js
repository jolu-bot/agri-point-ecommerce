...
const CATALOG = [
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    images:     ['/products/humiforte-20-5litres.png'],
    sku:        'KIT-HUM-5L-001',
    weight:     5,
    isActive:   true,
    isFeatured: false,
  ...
  },
  {
    ...
    images:     ['/products/fosnutren-20-5litres.png'],
    sku:        'KIT-FOS-5L-001',
    weight:     5,
    isActive:   true,
    isFeatured: false,
  ...
  },
  {
    ...
    images:     ['/products/kadostim-20-5litres.png'],
    sku:        'KIT-KAD-5L-001',
    weight:     5,
    isActive:   true,
    isFeatured: false,
  ...
  },
  {
    ...
    images:     ['/products/aminol-20-5litres.png'],
    sku:        'KIT-AMI-5L-001',
    weight:     5,
    isActive:   true,
    isFeatured: false,
