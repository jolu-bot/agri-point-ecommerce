        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="text-center">
            <motion.div
              ...
              className="inline-block px-6 py-3 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-full text-sm font-bold mb-8 shadow-lg"
            >
              ...
              >
                ...
                <div className="flex flex-wrap gap-1 mb-4">
                  {region.productions.map((p, i) => (
                    <span key={i} className="text-xs px-2 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-full font-medium">
                      🌱 {p}
                    </span>
                  ))}
                </div>
            ...
            {pageContent.steps.items.map((step, index) => (
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <div className="block px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 rounded-full text-xs font-bold w-fit">
                    ✅ {step.action}
                  </div>
                </div>
              </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {pageContent.testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <div className="mb-4">
                  <span className="inline-block px-4 py-2 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-full text-sm font-bold">
                    🌾 {testimonial.result}
                  </span>
                </div>
