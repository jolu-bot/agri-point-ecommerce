        ...
        <div className="container-fluid py-fluid-lg">
          ...
          >
            ...
            <m.div
              ...
              className="hidden md:block absolute -bottom-4 -left-4 lg:-bottom-6 lg:-left-6 bg-white dark:bg-gray-800 rounded-fluid-xl shadow-lg p-fluid-xs max-w-[200px] lg:max-w-xs"
            >
            ...
            <m.div
              ...
              className="hidden md:block absolute -top-4 -right-4 lg:-top-6 lg:-right-6 bg-white dark:bg-gray-800 rounded-fluid-xl shadow-lg p-fluid-xs max-w-[200px] lg:max-w-xs"
            >
              <div className="flex items-center space-x-2 lg:space-x-3">
                <div className="relative w-10 h-10 lg:w-12 lg:h-12 flex-shrink-0">
                  <Image
